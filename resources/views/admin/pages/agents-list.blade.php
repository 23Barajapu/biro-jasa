...
@php $subTitle = 'Agent List'; @endphp
                            ...
                            <div class="col-lg-6">
                                <form class="app-search d-none d-md-block me-auto">
                                    <div class="position-relative">
                                        <input autocomplete="off" class="form-control" placeholder="Search Agent"
                                               type="search" value=""/>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Michael
                                            A. Miner</a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>5 Year</td>
                            <td>21 May 2018</td>
                            <td><span class="badge bg-success-subtle text-success py-1 px-2 fs-13">Active</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Theresa
                                            T. Brose</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Walter
                                            L. Calab</a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>7 Year</td>
                            <td>04 Jan 2015</td>
                            <td><span class="badge bg-danger-subtle text-danger py-1 px-2 fs-13">Inactive</span>
                            </td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a class="btn btn-light btn-sm" href="#!">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Olive
                                            Mize</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Christa
                                            Sardina</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Darren
                                            Rivera</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <a class="text-dark fw-medium fs-15" href="#!">Lydia
                                            Anderson</a>
                                    </div>
                                </div>
                            </td>
