                    ...
                    <div>
                        <div class="avatar-md bg-primary bg-opacity-10 rounded">
                            <iconify-icon class="fs-32 text-primary avatar-title"
                                          icon="solar:calendar-date-broken"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <p class="mb-2 fs-15 fw-medium d-flex align-items-center gap-2">Earn Growth
                            <span class="badge text-success bg-success-subtle fs-11"><i class="ri-arrow-up-line"></i>44%</span>
                        </p>
                        <h3 class="text-dark fw-bold d-flex align-items-center gap-2 mb-0">$67435.00
                        </h3>
                    </div>
                    <div>
                        <div class="avatar-md bg-success bg-opacity-10 rounded">
                            <iconify-icon class="fs-32 text-success avatar-title"
                                          icon="solar:graph-new-broken"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <div class="avatar-md bg-warning bg-opacity-10 rounded">
                            <iconify-icon class="fs-32 text-warning avatar-title"
                                          icon="solar:user-plus-broken"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="avatar-md bg-info bg-opacity-10 rounded">
                            <iconify-icon class="fs-32 text-info avatar-title"
                                          icon="solar:chart-2-broken"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mx-n3">
                            <div class="apex-charts mb-3" data-colors="#604ae3" id="sales_funnel"></div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="d-flex align-items-center gap-2 text-dark fw-semibold">
                                    $15,563.786 <span class="badge text-success bg-success-subtle px-2 py-1 fs-12"><i
                            ...
                            <div class="avatar-md bg-light bg-opacity-50 rounded">
                                <iconify-icon class="fs-32 text-primary avatar-title"
                                              icon="solar:bag-2-broken"></iconify-icon>
                            </div>
                        </div>
                                ...
                                <div class="row g-2 text-center">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="border bg-light-subtle p-2 rounded">
                                            ...
                                            <h5 class="text-dark mb-1">$52,356 <span class="text-success font-size-13">0.2 % <i
                                    ...
                                    <div class="col-lg-4">
                                        <div class="border bg-light-subtle p-2 rounded">
                                            ...
                                            <h5 class="text-dark mb-1">$78M <span class="text-success font-size-13">0.1 % <i
                                                    class="mdi mdi-arrow-up ms-1"></i></span></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="apex-charts mt-5" id="markers"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="avatar-md bg-light bg-opacity-50 rounded">
                                <iconify-icon class="fs-32 text-primary avatar-title"
                                              icon="solar:hand-money-broken"></iconify-icon>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center bg-light-subtle border justify-content-between p-3 rounded mt-4">
                            ...
                            <div>
                                <a class="btn btn-primary" href="#!">Send Reminder</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-between mt-1">
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-md bg-light bg-opacity-50 rounded">
                                        <iconify-icon class="fs-32 text-primary avatar-title"
                                                      icon="solar:user-rounded-broken"></iconify-icon>
                                    </div>
                                    <div>
                            ...
                            <div class="col-lg-5" dir="ltr">
                                <div class="p-3 bg-light-subtle rounded border border-light">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1">
                                            <iconify-icon class="fs-16 align-middle me-1"
                                                          icon="circle-flags:us"></iconify-icon>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1">
                                            <iconify-icon class="fs-16 align-middle me-1"
                                                          icon="circle-flags:ru"></iconify-icon>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1">
                                            <iconify-icon class="fs-16 align-middle me-1"
                                                          icon="circle-flags:cn"></iconify-icon>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1">
                                            <iconify-icon class="fs-16 align-middle me-1"
                                                          icon="circle-flags:ca"></iconify-icon>
                                    ...
                                    <div class="mt-2 pt-1 text-center">
                                        <a class="link-primary" href="#!">Add Other <i class="ri-add-line"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="bg-primary position-relative rounded p-2 overflow-hidden z-1 text-center">
                    <img alt="" class="img-fluid rounded" src="{{ asset('assets/admin') }}/images/agent-1.png"/>
                    <div class="d-flex align-items-center justify-content-between bg-light bg-opacity-25 p-2 mt-2 rounded text-start">
                        <div>
                            <a class="text-white fw-medium fs-16" href="#!">Lahomes Group , Pvt Ltd</a>
...
<i class="ri-arrow-right-line"></i>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between pb-0">
                ...
                <div>
                    <a class="link-dark fs-20" href="#!"><i class="ri-settings-4-line"></i></a>
                </div>
            </div>
            <div class="card-body pt-0">
                <div class="apex-charts mb-4" id="agent_goals"></div>
...
<a class="text-dark fw-medium fs-15" href="#!">Ryan G. Harris</a>
</span>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between border-bottom gap-2 py-3">
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div class="d-block">
<span class="text-dark">
<a class="text-dark fw-medium fs-15" href="#!">Michael Coch</a>
</span>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between border-bottom gap-2 py-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-block">
<span class="text-dark">
<a class="text-dark fw-medium fs-15" href="#!">Danielle C. Thom</a>
</span>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 pt-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-block">
<span class="text-dark">
<a class="text-dark fw-medium fs-15" href="#!">Julia V. Quincy</a>
</span>
