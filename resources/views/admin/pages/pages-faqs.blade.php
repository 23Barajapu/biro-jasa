...
<div class="row g-xl-4">
    <div class="col-xl-6">
        ...
        <div class="accordion">
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button aria-controls="faq4" aria-expanded="true" class="accordion-button fw-medium"
    ...
    <div class="col-xl-6">
        ...
        <div class="accordion">
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button aria-controls="faq10" aria-expanded="true" class="accordion-button fw-medium"
                            data-bs-target="#faq10" data-bs-toggle="collapse" type="button">
                        How do I contact customer support?
                    </button>
                </h2>
                <div aria-labelledby="faq10" class="accordion-collapse collapse show" id="faq10">
                    <div class="accordion-body">
...
<div class="row my-5">
    <div class="col-12 text-center">
        ...
        <button class="btn btn-success mt-2" type="button"><i class="ri-mail-line me-1"></i> Email
            us your question
        </button>
        <button class="btn btn-info mt-2 ms-1" type="button"><i class="ri-twitter-line me-1"></i>
            Send us a tweet
        </button>
    </div>
</div>
