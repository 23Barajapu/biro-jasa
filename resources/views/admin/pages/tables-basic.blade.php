...
@php $subTitle = 'Basic Tables'; @endphp
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted font-14"> For basic styling—light padding and only
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="striped">Striped Rows Table <a class="anchor-link"
                                                                                      href="#striped">#</a></h5>
                <p class="text-muted font-14">
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted font-14"> Add a thicker border, darker between table
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted font-14">A <code>&lt;caption&gt;</code> functions like a
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-borderless table-centered">
                        ...
                        <tr>
                            <th scope="col">
                                <div class="form-check">
                                    <input class="form-check-input" id="flexCheckDefault5" type="checkbox" value=""/>
                                </div>
                            </th>
                            <th scope="col">Name</th>
                            <th scope="col">Title</th>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" id="flexCheckDefault3" type="checkbox" value=""/>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" id="flexCheckDefault4" type="checkbox" value=""/>
                                </div>
                            </td>
                            <td>
                                Mary J. Germain <i class="bx bxs-badge-check text-success"></i>
                            ...
                            <td colspan="4">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-success-subtle text-success py-1 px-2">Verified</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3-128-2</td>
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#inverse">Inverse Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#striped">Striped Rows Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#hoverable-row">Hoverable rows </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#active">Active Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#bordered">Bordered Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#border-color">Bordered color Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#borderless">Basic Borderless Example </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#small">Small Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#alignment ">Alignment Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#nesting">Nesting Table </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#head-option">Table head options </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#tablefoot">Tablefoot</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#captions">Captions</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#responsive">Always Responsive Table </a>
                </li>
            </ul>
        </div>
    </div>
