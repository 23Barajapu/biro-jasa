...
@php $subTitle = 'Messages'; @endphp
@php $title = 'Real Estate'; @endphp
@include('admin.partials.page-title')

<div class="row g-1">
    <div class="col-xxl-3">
        <div aria-labelledby="ContactoffcanvasLabel" class="offcanvas-xxl offcanvas-start h-100" id="Contactoffcanvas"
             tabindex="-1">
                ...
                <div class="card-header border-0 d-flex justify-content-between align-items-center gap-3">
                    <form class="chat-search pb-0">
                        <div class="chat-search-box">
                            ...
                            <button class="btn btn-sm btn-link search-icon p-0 fs-15" type="submit"><i
                                    class="ri-search-eye-line"></i></button>
                        </div>
                    </form>
                    <a aria-expanded="true" aria-haspopup="true" class="fs-20" data-bs-toggle="offcanvas"
                       href="#user-setting" type="button">
                ...
                <div class="swiper mySwiper mx-3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide avatar">
                            <a class="rounded-circle" data-bs-target="#exampleModal" data-bs-toggle="modal" href="#!">
...
<span class="visually-hidden">New alerts</span>
                ...
                <ul class="nav nav-pills chat-tab-pills nav-justified p-1 rounded mx-1">
                    <li class="nav-item">
                        <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab" href="#chat-list">
                            Chat
                        </a>
                    </li>
                    <li class="nav-item">
                        <a aria-expanded="true" class="nav-link" data-bs-toggle="tab" href="#group-list">
                            Group
                        </a>
                    </li>
                    <li class="nav-item">
                        <a aria-expanded="true" class="nav-link" data-bs-toggle="tab" href="#contact-list">
                            Contact
                        </a>
                    </li>
                </ul>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1 d-flex align-items-center gap-1">
                                                    <iconify-icon class="text-warning fs-18"
                                                                  icon="solar:hand-shake-bold-duotone"></iconify-icon>
                                                    Hi John, How are you?
                                                </p>
                                                <div>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-primary fst-italic">
                                                    typing....</p>
                                ...
                                <a class="d-block" href="#!">
                                    <div class="d-flex align-items-center p-2 mb-1 rounded">
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
                                                    <iconify-icon class="fs-18 text-danger"
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
                                                    Why aren't you writing? We don't...
                                                </p>
...
<i class="ri-group-line"></i>
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            <h5 class="mb-0 fw-medium">Create New Group
                                            </h5>
                                        </div>
                                    </div>
                                </a>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
<span class="fw-medium text-primary">HG
                                                                                          :</span>Good morning everyone
                                                    !</p>
                                                <span class="badge bg-danger badge-pill">1</span>
                                            </div>
                                        </div>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
<span class="fw-medium text-primary">RK
                                                                                          :</span>This themes is
                                                    awesome! ...</p>
                                                <i class="ri-check-double-line fs-18 text-primary"></i>
                                            </div>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
<span class="fw-medium text-primary">Susan
                                                                                          :</span>Hey...😊</p>
                                                <i class="ri-check-double-line fs-18 text-primary"></i>
                                            </div>
                                        </div>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
<span class="fw-medium text-primary">Angela
                                                                                          :</span>Today work is...</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
...
<span class="visually-hidden">New
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 text-muted d-flex align-items-center gap-1">
<span class="fw-medium text-primary">HR
                                                                                          :</span>Next meeting today
                                                    10am</p>
                                                <span class="badge bg-danger badge-pill">1</span>
                                            </div>
                                        </div>
...
<i class="ri-user-add-line"></i>
                                        ...
                                        <div class="d-block ms-3 flex-grow-1">
                                            <h5 class="mb-0 fw-medium">Add New Contact
                                            </h5>
                                        </div>
                                        <iconify-icon class="fs-20 text-primary"
                                                      icon="solar:qr-code-bold-duotone"></iconify-icon>
                                    </div>
                                </a>
                            </div>
                            <div class="d-flex flex-column h-100 border-bottom">
                ...
                <div aria-labelledby="user-settingLabel"
                     class="offcanvas offcanvas-start position-absolute shadow w-100" data-bs-backdrop="false"
                     data-bs-scroll="true" id="user-setting" tabindex="-1">
                    ...
                    <div class="offcanvas-body p-0 h-100" data-simplebar="">
                        ...
                        <div class="d-flex align-items-center px-3 pb-3 border-bottom">
                            <img alt="avatar-1" class="me-2 rounded-circle" height="36"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mt-1 mb-0 text-muted"><span class="w-75">Hey
                                                                      there! I am using Chat.</span></p>
                            </div>
                            </img></div>
                            ...
                            <div class="accordion custom-accordion" id="accordionSetting">
                                <div class="accordion-item border-0">
                                    <h5 class="accordion-header my-0" id="headingAccount">
                                        <button aria-controls="collapseAccount" aria-expanded="false"
                                                class="accordion-button px-0 pt-0 collapsed"
                                                data-bs-target="#collapseAccount" data-bs-toggle="collapse"
                                                type="button">
...
<span class="mt-1 mb-0 text-muted w-75">Privacy,
                                                                                          security, change number</span>
</span>
</span>
                                        </button> <!-- end accordion button -->
                                    </h5> <!-- end accordion header -->
                                    <div aria-labelledby="headingAccount" class="accordion-collapse collapse"
                                         data-bs-parent="#accordionSetting" id="collapseAccount">
                                        <div class="accordion-body pb-0">
                                            <ul class="list-unstyled mb-0">
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-lock-2-line fs-18 me-2"></i>Privacy</a>
                                                </li>
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-pass-valid-line fs-18 me-2"></i>Security</a>
                                                </li>
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-verified-badge-line fs-18 me-2"></i>Two-step
                                                    verification</a></li>
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-expand-right-line fs-18 me-2"></i>Change
                                                    number</a></li>
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-error-warning-line fs-18 me-2"></i>Request
                                                    account info</a></li>
                                                <li><a href="javascript:void(0);"><i
                                                        class="ri-delete-bin-6-line fs-18 me-2"></i>Delete
                                                    my account</a></li>
                                            </ul>
                                ...
                                <div class="accordion-item border-0">
                                    <h5 class="accordion-header my-0" id="headingChats">
                                        <button aria-controls="collapseChats" aria-expanded="false"
                                                class="accordion-button px-0 collapsed" data-bs-target="#collapseChats"
...
<span class="mt-1 mb-0 text-muted w-75">Theme,
                                    ...
                                    <div aria-labelledby="headingChats" class="accordion-collapse collapse"
                                         data-bs-parent="#accordionSetting" id="collapseChats">
                                        <div class="accordion-body pb-0">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-image-line fs-16 me-2"></i>Wallpaper</a>
                                                </li>
                                            </ul>
                                            <hr/>
                                            <h5>Chat Setting</h5>
                                                ...
                                                <li class="mb-2 ms-2">
                                                    <div class="float-end">
                                                        <div class="form-check form-switch">
                                                            <input checked="" class="form-check-input" id="media"
                                                                   type="checkbox"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p class="mb-0 text-muted fs-12">
                                                        ...
                                                        your phone's gallery</p>
                                                </li>
                                                <li class="mb-2 ms-2">
                                                    <div class="float-end">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" id="enter" type="checkbox"/>
                                                        </div>
                                                    </div>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-upload-cloud-line fs-16 me-2"></i>Chat
                                                    Backup</a></li>
                                                <li><a href="javascript:void(0);"><i
                                                        class="ri-chat-history-line fs-16 me-2"></i>Chat
                                                    History</a></li>
                                            </ul>
                                        </div> <!-- end accordion body -->
                                    </div> <!-- end accordion collapse -->
                                ...
                                <div class="accordion-item border-0">
                                    <h5 class="accordion-header my-0" id="headingNotification">
                                        <button aria-controls="collapseNotification" aria-expanded="false"
                                                class="accordion-button px-0 collapsed"
                                                data-bs-target="#collapseNotification" data-bs-toggle="collapse"
                                                type="button">
<span class="d-flex align-items-center">
...
<span class="mt-1 mb-0 text-muted w-75">Message,
                                                                                          group, call tones</span>
</span>
</span>
                                        </button> <!-- end accordion button -->
                                    </h5> <!-- end accordion header -->
                                    <div aria-labelledby="headingNotification" class="accordion-collapse collapse"
                                         data-bs-parent="#accordionSetting" id="collapseNotification">
                                        <div class="accordion-body pb-0">
                                            <ul class="list-unstyled mb-0">
                                                <li class="mb-2">
                                                    <div class="float-end">
                                                        <div class="form-check form-switch">
                                                            <input checked="" class="form-check-input" id="conversation"
                                                                   type="checkbox"/>
                                                        </div>
                                                    </div>
                                ...
                                <div class="accordion-item border-0">
                                    <h5 class="accordion-header my-0" id="headingStorage">
                                        <button aria-controls="collapseStorage" aria-expanded="false"
                                                class="accordion-button px-0 collapsed"
                                                data-bs-target="#collapseStorage" data-bs-toggle="collapse"
                                                type="button">
<span class="d-flex align-items-center">
...
<span class="mt-1 mb-0 text-muted w-75">Network
                                                                                          usage, auto download</span>
</span>
</span>
                                        </button> <!-- end accordion button -->
                                    </h5> <!-- end accordion header -->
                                    <div aria-labelledby="headingStorage" class="accordion-collapse collapse"
                                         data-bs-parent="#accordionSetting" id="collapseStorage">
                                        <div class="accordion-body pb-0">
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex">
                                            ...
                                            <p class="mb-0 text-muted fs-12">Voice
                                                message are always automatically
                                                downloaded</p>
                                            <ul class="list-unstyled mb-0 mt-2">
                                                <li class="mb-2">
                                                    <a href="javascript:void(0);">When
                                                        using mobile data</a>
                                                    <p class="mb-0 text-muted fs-12">No
                                                        media</p>
                                                </li>
                                                <li class="mb-2 ms-2">
                                                    <a href="javascript:void(0);">When
                                                        connected on wi-fi</a>
                                                    <p class="mb-0 text-muted fs-12">No
                                                        media</p>
                                                </li>
                                                <li class="mb-2 ms-2">
                                            ...
                                            <p class="mb-0 text-muted fs-12">Choose the
                                                quality of media files to be sent</p>
                                            <ul class="list-unstyled mb-0 mt-2">
                                                <li class="ms-2">
                                ...
                                <div class="accordion-item border-0">
                                    <h5 class="accordion-header my-0" id="headingHelp">
                                        <button aria-controls="collapseHelp" aria-expanded="false"
                                                class="accordion-button px-0 collapsed" data-bs-target="#collapseHelp"
                                                data-bs-toggle="collapse" type="button">
<span class="d-flex align-items-center">
...
<span class="mt-1 mb-0 text-muted w-75">Help
                                                                                          center, contact us, privacy
                                                                                          policy</span>
</span>
</span>
                                        </button> <!-- end accordion button -->
                                    </h5> <!-- end accordion header -->
                                    <div aria-labelledby="headingHelp" class="accordion-collapse collapse"
                                         data-bs-parent="#accordionSetting" id="collapseHelp">
                                        <div class="accordion-body pb-0">
                                            <ul class="list-unstyled mb-0">
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-information-2-line fs-16 me-2"></i>Help
                                                    center</a></li>
                                                <li class="mb-2 d-flex">
                                                ...
                                                <li class="mb-2"><a href="javascript:void(0);"><i
                                                        class="ri-contacts-book-3-line fs-16 me-2"></i>Teams
                                                    and Privacy Policy</a></li>
                                                <li><a href="javascript:void(0);"><i
                                                        class="ri-information-2-line fs-16 me-2"></i>App
                                                    info</a></li>
                                            </ul>
                                        </div> <!-- end accordion body -->
                                    </div> <!-- end accordion collapse -->
    ...
    <div class="col-xxl-9">
        <div class="card position-relative overflow-hidden">
            <div class="card-header d-flex align-items-center mh-100 bg-light-subtle">
                <button aria-controls="Contactoffcanvas"
                        class="btn btn-light d-xxl-none d-flex align-items-center px-2 me-2"
                        data-bs-target="#Contactoffcanvas" data-bs-toggle="offcanvas" type="button">
                    <i class="ri-menu-line fs-18"></i>
                </button>
                <div class="d-flex align-items-center">
                    <img alt="avatar-4" class="me-2 rounded" height="36"
                         src="{{ asset('assets/admin') }}/images/users/avatar-4.jpg">
                    <div class="d-none d-md-flex flex-column">
                        <h5 class="my-0 fs-16 fw-semibold">
                            <a class="text-dark" data-bs-toggle="offcanvas" href="#user-profile">
                                David Wilson
                            </a>
                        </h5>
                ...
                <div class="flex-grow-1">
                    <ul class="list-inline float-end d-flex gap-1 mb-0 align-items-center">
                        <li class="list-inline-item fs-20 dropdown">
                            <a class="btn btn-light avatar-sm d-flex align-items-center justify-content-center text-dark fs-20"
                               data-bs-target="#videocall" data-bs-toggle="modal" href="javascript: void(0);">
                                <iconify-icon icon="solar:videocamera-record-bold-duotone"></iconify-icon>
                            </a>
                        </li>
                        <li class="list-inline-item fs-20 dropdown">
                            <a class="btn btn-light avatar-sm d-flex align-items-center justify-content-center text-dark fs-20"
                               data-bs-target="#voicecall" data-bs-toggle="modal" href="javascript: void(0);">
                        ...
                        <li class="list-inline-item fs-20 dropdown d-none d-md-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="javascript: void(0);"><i
                                        class="ri-music-2-line me-2"></i>Media, Links and
                                    Docs</a>
                                <a class="dropdown-item" href="javascript: void(0);"><i
            ...
            <div class="chat-box">
                <ul class="chat-conversation-list p-3 chatbox-height">
                    <li class="d-flex gap-2 clearfix">
                        ...
                        <div class="chat-conversation-text">
                            <div>
                                <p class="mb-2"><span class="text-dark fw-medium me-1">David</span>
                                    08:30</p>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div class="chat-conversation-actions dropdown dropend">
                                    <a aria-expanded="false" class="ps-1" data-bs-toggle="dropdown"
                                       href="javascript: void(0);"><i class="ri-more-2-fill fs-18"></i></a>
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="javascript: void(0);">
                                            <i class="ri-information-2-line me-2"></i>Mark
                                            as Unread
                                        </a>
                                        <a class="dropdown-item" href="javascript: void(0);">
                        ...
                        <div class="chat-conversation-text ms-0">
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="chat-conversation-actions dropdown dropstart">
                                    <a aria-expanded="false" class="pe-1" data-bs-toggle="dropdown"
                                       href="javascript: void(0);"><i class="ri-more-2-fill fs-18"></i></a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript: void(0);">
                                            <i class="ri-share-forward-line me-2"></i>Reply
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                ...
                                <div class="chat-ctext-wrap">
                                    <p>What's you project update? Are you having any
                                        trouble?</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="d-flex gap-2 clearfix">
                        ...
                        <div class="chat-conversation-text">
                            ...
                            <div class="d-flex align-items-start">
                                <div class="chat-ctext-wrap">
                                    <p>No, going all perfect! Let me show you images of the
                                        project.</p>
                                </div>
                                <div class="chat-conversation-actions dropdown dropend">
                                    <a aria-expanded="false" class="ps-1" data-bs-toggle="dropdown"
                            ...
                            <div class="d-flex align-items-start mt-2">
                                <div class="chat-ctext-wrap">
                                    <a href="javascript:void(0);">
                                        <img alt="attachment" class="img-thumbnail me-1"
                            ...
                            <div class="d-flex align-items-start">
                                <div class="chat-ctext-wrap text-start">
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        ...
                                        <div class="flex-grow-1">
                                            <a class="text-dark" href="javascript:void(0);">admin-dashboard2024.zip</a>
                    ...
                    <li class="d-flex justify-content-end gap-2 clearfix odd">
                        <div class="chat-conversation-text ms-0">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                ...
                                <div class="chat-ctext-wrap">
                                    <p>Thank you, believe me, I will be very happy to see
                                        the results of my efforts. Thank you for the good
                                        feeling you give me</p>
                                </div>
                            </div>
                        </div>
                        <div class="chat-avatar text-center">
                    ...
                    <li class="d-flex gap-2 clearfix">
                        ...
                        <div class="chat-conversation-text">
                            ...
                            <div class="d-flex align-items-start mt-2">
                                <div class="chat-ctext-wrap">
                                    <p>Thanks, Gaston. I appreciate your support. Overall,
                                        I'm optimistic about our team's performance and
                                        looking forward to tackling new challenges in the
                                        next quarter.</p>
                                </div>
                                <div class="chat-conversation-actions dropdown dropend">
                                    <a aria-expanded="false" class="ps-1" data-bs-toggle="dropdown"
                ...
                <div class="bg-light bg-opacity-50 p-2">
                    <form class="needs-validation" id="chat-form" name="chat-form">
                        <div class="row align-items-center">
                            <div class="col mb-2 mb-sm-0 d-flex">
                                <div class="input-group">
                                    <a class="btn btn-sm btn-primary rounded-start d-flex align-items-center input-group-text"
                                       href="javascript: void(0);"><i class="ri-emotion-line fs-18"></i></a>
                                    <input class="form-control border-0" placeholder="Enter your message" type="text"/>
                                </div>
                            </div>
                            <div class="col-sm-auto">
                                <div class="d-flex gap-2">
                                    <a class="btn btn-soft-success btn-sm" href="#!"><i
                                            class="ri-attachment-2 fs-18"></i></a>
                                    <a class="btn btn-soft-warning btn-sm" href="#!"><i
                                            class="ri-video-on-line fs-18"></i></a>
                                    <button class="btn btn-primary btn-sm chat-send" type="submit"><i
                                            class="ri-send-plane-2-line fs-18"></i></button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <!-- video call Modal -->
            <div aria-hidden="true" class="modal fade" id="videocall">
                    ...
                    <div class="modal-content video-call overflow-hidden mx-auto">
                        <div class="modal-header border-0 mb-5 justify-content-end">
                            <div class="video-call-head">
                                <img alt="avatar-4" class="rounded"
                                     src="{{ asset('assets/admin') }}/images/users/avatar-1.jpg">
                                </img></div>
                        </div>
                            ...
                            <div class="video-call-action text-center pt-4 pb-0">
                                <ul class="d-flex align-items-center justify-content-evenly bg-dark m-3 p-2 rounded-pill">
                                    ...
                                    <li class="list-inline-item fw-bold" data-bs-dismiss="modal">
                                        <a class="btn btn-danger btn-sm rounded-pill" href="#!"><i
                                                class="ri-phone-line me-1"></i>10:02</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <!-- voice call modal -->
            <div aria-hidden="true" class="modal fade" id="voicecall">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content voice-call mx-auto overflow-hidden">
                        <div class="modal-header border-0 mt-5 justify-content-center">
                            <div class="voice-call-head">
                                <img alt="avatar-4" class="rounded-circle"
                                     src="{{ asset('assets/admin') }}/images/users/avatar-4.jpg">
                                </img></div>
                        </div>
            ...
            <!-- Profile Start -->
            <div aria-labelledby="user-profileLabel"
                 class="offcanvas offcanvas-end position-absolute shadow border-start" data-bs-backdrop="false"
                 data-bs-scroll="true" id="user-profile" tabindex="-1">
                <div class="offcanvas-header">
                ...
                <div class="offcanvas-body p-0 h-100" data-simplebar="">
                    <div class="p-3">
                        <div class="text-center">
                            <img alt="shreyu" class="img-thumbnail avatar-lg rounded-circle mb-1"
                                 src="{{ asset('assets/admin') }}/images/users/avatar-4.jpg"/>
                            <h4>Gilbert Chicoine</h4>
                            <button class="btn btn-primary btn-sm mt-1"><i class="ri-mail-line me-1"></i>Send Email
                            </button>
                            <p class="text-muted mt-2 fs-14">Last Interacted: <strong
                                    class="text-success">Online</strong></p>
                        </div>
                        <div class="mt-3">
                            <hr/>
                            <p class="mt-3 mb-1"><strong><i class="ri-phone-line"></i> Phone
                                Number:</strong></p>
                            <p>+1 456 9595 9594</p>
                            <p class="mt-3 mb-1"><strong><i class="ri-map-pin-line"></i>
                                Location:</strong></p>
                            <p>California, USA</p>
                            <p class="mt-3 mb-1"><strong><i class="ri-global-line"></i>
                                Languages:</strong></p>
                            <p>English, German, Spanish</p>
                            <p class="mt-3 mb-2"><strong><i class="ri-group-3-line"></i>
                                Groups:</strong></p>
                            <p class="mb-0">
                        ...
                        <div class="row gx-1 pt-2">
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <img alt="img-1" class="img-fluid rounded"
                                         src="{{ asset('assets/admin') }}/images/small/img-1.jpg"/>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <img alt="img-2" class="img-fluid rounded"
                            ...
                            <div class="col-4">
                                <div class="position-relative overflow-hidden rounded">
                                    <a href="javascript:void(0);">
                                        <img alt="img-3" class="img-fluid rounded"
