...
@php $subTitle = 'Input Mask'; @endphp
            ...
            <div class="card-body">
                <h5 class="card-title anchor" id="overview">
                    Overview <a class="btn btn-sm btn-outline-success rounded-2 float-end"
                                href="https://github.com/RobinHerbots/Inputmask" target="_blank">
                    Official Website </a>
                </h5>
                <p class="text-muted mb-3">Inputmask is a javascript library that creates an
                    input mask.</p>
                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">Input Masks's Javascript files are bundled in the
                    <code>vendors.js</code> and globally included in all pages.</p>
            </div><!-- end card-body -->
        </div><!-- end card -->
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">A Java-Script Plugin to make masks on form fields and HTML
                    elements.</p>
                <div>
                    <!-- Input masks -->
                    <div class="row">
                        <div class="col-md-6">
                            <form action="#">
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="fs-13 text-muted">e.g "DD/MM/YYYY
                                                                      HH:MM:SS"</span>
                                    <p class="mt-1">Add attribute
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="mt-1">Add attribute
                                        <code>data-toggle="input-mask" data-mask-format="#.##0,00"
                        ...
                        <div class="col-md-6">
                            <form action="#">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Telephone with Code
                                        Area</label>
                                    <input class="form-control" data-mask-format="(00) 0000-0000"
                                           data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g "(xx)
                                                                      xxxx-xxxx"</span>
                                    <p class="mt-1">Add attribute
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" data-mask-format="(000) 000-0000"
                                           data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g "(xxx)
                                                                      xxx-xxxx"</span>
                                    <p class="mt-1">Add attribute
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" data-mask-format="(00) 00000-0000"
                                           data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g "(xx)
                                                                      xxxxx-xxxx"</span>
                                    <p class="mt-1">Add attribute
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" data-mask-format="000.000.000-00" data-reverse="true"
                                           data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g
                                                                      "xxx.xxx.xxxx-xx"</span>
                                    <p class="mt-1">Add attribute
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" data-mask-format="00.000.000/0000-00"
                                           data-reverse="true" data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g
                                                                      "xx.xxx.xxx/xxxx-xx"</span>
                                    <p class="mt-1">Add attribute
                                        <code>data-toggle="input-mask" data-mask-format="00.000.000/0000-00"
                                            data-reverse="true"</code>
                                    </p>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" data-mask-format="099.099.099.099" data-reverse="true"
                                           data-toggle="input-mask" type="text"/>
                                    <span class="fs-13 text-muted">e.g
                                                                      "xxx.xxx.xxx.xxx"</span>
                                    <p class="mt-1">Add attribute
                                        <code>data-toggle="input-mask" data-mask-format="099.099.099.099"
                                            data-reverse="true"</code>
                                    </p>
                                </div>
                            </form>
