        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between bg-light border-top border-bottom py-1 px-3">
                    ...
                    <button class="btn btn-sm btn-outline-success btn-copy-clipboard" data-clipboard-action="copy"
                            data-clipboard-target="#size">Copy
                    </button>
                </div>
                <div class="code">
<pre class="language-html">
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="#border_spinner">Border spinner</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#color_spinners">Color Spinners</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#growing_spinners">Growing Spinners</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#color_growing">Color Growing Spinners</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#button_spinner">Buttons Spinner</a>
                </li>
            </ul>
        </div>
    </div>
