...
@php $subTitle = 'Grid JS'; @endphp
@php $title = 'Table'; @endphp
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title anchor mb-1" id="overview">
                    Overview <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://gridjs.io"
...
<pre class="language-javascript">
                                                        ...
                                                        if (document.getElementById("table-gridjs"))
                                                             new gridjs.Grid({
                                                                  columns: [{
                                                                       ...
                                                                       formatter: (function (cell) {
                                                                            return gridjs.html('<span
                                                            class="fw-semibold">' + cell + '</span>');
                                                                       })
                                                                  },
                                                                       "Name",
                                                                  {
                                                            ...
                                                            href="">' + cell + '</a>');
                                                                       ...
                                                                       "Position", "Company", "Country",
                                                                  {
                                                                       ...
                                                                       formatter: (function (cell) {
                                                                            return gridjs.html("<a
                                                            class="text-reset text-decoration-underline" href="#">" + "Details" + "</a>");
                                                                       })
                                                                  },
                                                                  ],
                                                                  pagination: {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Pagination can be enabled by setting
                    <code>pagination: true</code>:</p>
                <div class="py-3">
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-pagination-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-pagination-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
...
<pre class="language-javascript">
                                                        ...
                                                        if (document.getElementById("table-pagination"))
                                                             new gridjs.Grid({
                                                                  columns: [{
                                                                       ...
                                                                       width: '120px',
                                                                       formatter: (function (cell) {
                                                                            return gridjs.html('<a class="fw-medium"
                                                                                                   href="">' + cell + '</a>');
                                                                       })
                                                                  }, "Name", "Date", "Total",
                                                                  {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Grid.js supports global search on all rows and columns. Set
                    <code>search: true</code> to enable the search plugin:</p>
                <div class="py-3">
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-search-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-search-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">To enable sorting, simply add <code>sort: true</code> to your
                    config:</p>
                <div class="py-3">
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-sorting-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-sorting-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Grid.js renders a loading bar automatically while it waits for the
                    data to be fetched. Here we are using an async
                    function to demonstrate this behaviour (e.g. an async function can be a XHR call to
                    a server backend)</p>
                <div class="py-3">
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-loading-state-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-loading-state-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-fixed-header-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-fixed-header-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Add <code>hidden: true</code> to the columns definition to hide
                    them. </p>
                <div class="py-3">
                ...
                <div class="highlight border rounded">
                    <div class="highlight-toolbar border-top-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#gridjs-hidden-column-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#gridjs-hidden-column-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
    ...
    <div class="col-xl-2">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#loading_state">Loading State</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#fixed_header">Fixed Header</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#hidden_column">Hidden Columns</a>
                </li>
            </ul>
        </div>
    </div> <!-- end col -->
