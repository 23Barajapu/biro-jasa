...
@section('title', 'Apex Bubble Chart')

@section('extra_css')

@section('page_content')

@php $subTitle = 'Bubble'; @endphp
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart
                                        at:</span> <code> ../static/js/components/apexchart-bubble.js</code></p>
            </div><!-- end card-body -->
        </div><!-- end card -->
        <div class="card">
            <div class="card-body">
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#simple">Simple Bubble Chart</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#3d-bubble">3D Bubble Chart</a>
                </li>
            </ul>
        </div>
    </div>
...
<script src="{{ asset('assets/admin') }}/js/components/apexchart-bubble.js"></script>
@endsection
