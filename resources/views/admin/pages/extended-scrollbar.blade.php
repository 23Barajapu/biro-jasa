...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Just use data attribute <code>data-simplebar</code>,
                    <code>data-simplebar-lg</code> and add <code>max-height: **px</code> oh fix height
                </p>
                <div class="border rounded py-3 mb-3">
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="#default ">Default Scroll Example </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#rtl ">RTL Position </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#size ">Scroll Size </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#color ">Scroll Color </a>
                </li>
            </ul>
        </div>
    </div>
