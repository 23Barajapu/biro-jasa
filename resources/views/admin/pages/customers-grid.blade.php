...
@section('title', 'Customer Grid')

@section('extra_css')

@section('page_content')

@php $subTitle = 'Customer Grid'; @endphp
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
</span>
                </div>
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}">Daavid Nummi</a>
                        <div>
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
                ...
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}">Sinikka Penttinen</a>
                        <div>
                            <span class="badge bg-success text-white fs-12 px-2 py-1">Available</span>
                        </div>
                    </div>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Email Address : </span>
                        sinikkapenttinen@dayrep.com</p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span>
                        +231 47-23456789
                    </p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Jean
                        Racinelaan 48 5629
                        PK Eindhoven</p>
                    <div class="row mt-3 justify-content-between">
                        <div class="col-lg-3">
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
                ...
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}">Jere Palmu</a>
                        <div>
                            <span class="badge bg-success text-white fs-12 px-2 py-1">Available</span>
                        </div>
                    </div>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Email Address : </span>
                        jerepalmu@rhyta.com</p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span>
                        +231 73-34567890
                    </p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Alkmenehof
                        124 2728 KA
                        Zoetermeer </p>
                    <div class="row mt-3 justify-content-between">
                        <div class="col-lg-3">
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
                ...
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}">Ulla Nuorela</a>
                        <div>
                            <span class="badge bg-danger text-white fs-12 px-2 py-1">Unavailable</span>
                        </div>
                    </div>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Email Address : </span>
                        ullanuorela@rhyta.com</p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span>
                        +231 45-45678901
                    </p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Oudegracht
                        135 3511 NJ
                        Utrecht </p>
                    <div class="row mt-3 justify-content-between">
                        <div class="col-lg-3">
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
                ...
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}">Tiia Karppinen</a>
                        <div>
                            <span class="badge bg-success text-white fs-12 px-2 py-1">Available</span>
                        </div>
                    </div>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Email Address : </span>
                        tiiakarppinen@teleworm.us</p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span>
                        +231 16-56789012
                    </p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Willem de
                        Zwijgerlaan
                        183 2315 AT Leiden</p>
                    <div class="row mt-3 justify-content-between">
                        <div class="col-lg-3">
                            <p class="fw-medium mb-2">View Property</p>
...
<button class="btn btn-dark avatar-sm d-inline-flex align-items-center justify-content-center fs-20 rounded text-light"
        type="button"><iconify-icon icon="solar:pen-new-square-broken"></iconify-icon></button>
                ...
                <div class="mt-5 pt-3 ms-1">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="fs-18 link-primary fw-semibold" href="{{ url('/admin/customers-details') }}"> Harland R. Orsini</a>
                        <div>
                            <span class="badge bg-danger text-white fs-12 px-2 py-1">Unavailable</span>
                        </div>
                    </div>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Email Address : </span>
                        harlandrorsini@dayrep.com</p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span>
                        +231 82-67890123
                    </p>
                    <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Bongerd
                        116 6367 CL
                        Voerendaal</p>
                    <div class="row mt-3 justify-content-between">
                        <div class="col-lg-3">
