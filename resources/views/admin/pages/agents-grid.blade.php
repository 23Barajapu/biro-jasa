...
@section('title', 'Agent Grid')

@section('extra_css')

@section('page_content')

@php $subTitle = 'Agent Grid'; @endphp
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="row align-items-center text-center mb-2">
                            <div class="col-lg-7 border-end border-light">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="apex-charts" id="grid-chart"></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <h5>Properties</h5>
                            ...
                            <div class="col-lg-5">
                                <div class="ps-2">
                                    <p class="d-flex align-items-center mb-2 gap-2"><i
                                            class="ri-circle-fill text-primary"></i>80
                                        Vacant</p>
                                    <p class="d-flex align-items-center mb-2 gap-2"><i
                                            class="ri-circle-fill text-warning"></i>40
                                        Occupied</p>
                                    <p class="d-flex align-items-center gap-2 mb-0"><i
                                            class="ri-circle-fill text-success"></i>30
                                        Unlisted</p>
                                </div>
                            </div>
                        </div>
                        <p class="text-muted mb-0 d-flex align-items-center gap-1">Last
                            Updated <span>:</span> <span class="text-dark">4 day ago</span>
                        </p>
                    </div>
                    <div class="col-lg-5 text-end">
                        <img alt="" class="img-fluid" src="{{ asset('assets/admin') }}/images/home-2.png"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-header d-flex align-items-center border-bottom border-dashed">
                ...
                <div class="ms-auto">
                    <div class="dropdown">
                        <a aria-expanded="false" class="dropdown-toggle drop-arrow-none card-drop p-0"
            ...
            <div class="card-body">
                ...
                <div class="progress progress-lg bg-light-subtle rounded-0 gap-1 overflow-visible mt-2"
                     style="height: 10px">
                ...
                <p class="mb-0 mt-3"><span class="text-success fw-medium mb-0"><i
                        class="ri-arrow-up-line"></i>34.4%</span> vs last month</p>
            </div>
            <div class="card-footer d-flex justify-content-between py-2">
                <p class="text-muted mb-0 d-flex align-items-center gap-1">Last Updated
                    <span>:</span> <span class="text-dark">12 hour ago</span></p>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card bg-primary bg-gradient">
            <div class="card-body">
                ...
                <div class="apex-charts" data-colors="#ffffff" id="seal_properties"></div>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="text-md-end mt-3 mt-md-0">
                            ...
                            <button class="btn btn-success me-1" type="button"><i class="ri-add-line"></i> New Agent
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ms-auto">
                        <div class="dropdown">
                            <a aria-expanded="false"
                               class="dropdown-toggle btn btn-sm btn-outline-light rounded arrow-none fs-16"
                               data-bs-toggle="dropdown" href="#">
                    ...
                    <div class="col-lg-6">
                        <a class="btn btn-primary w-100" href="#!">
                            <iconify-icon class="align-middle fs-18"
                                          icon="solar:outgoing-call-rounded-broken"></iconify-icon>
                            Call Us</a>
                    </div>
                    <div class="col-lg-6">
                        <a class="btn btn-light w-100" href="#!">
                            <iconify-icon class="align-middle fs-16" icon="solar:chat-round-dots-broken"></iconify-icon>
                            Message</a>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!"> Theresa T. Brose</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!"> Walter L. Calab</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!"> Olive Mize</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!"> Christa Sardina</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!"> Darren Rivera</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!">Robert V. Leavitt</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!">Lydia Anderson</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center gap-2 border-bottom pb-3">
                    ...
                    <div class="d-block">
                        <a class="text-dark fw-medium fs-16" href="#!">Sarah Martinez</a>
...
<script src="{{ asset('assets/admin') }}/js/pages/agent-grid.js"></script>
@endsection
