...
<div class="card">
    <div class="row g-0">
        <div class="col-xl-2">
            <div aria-labelledby="offcanvasExampleLabel" class="offcanvas-xl offcanvas-start" id="offcanvasExample"
                 tabindex="-1">
                <div>
        ...
        <div class="col-xl-3">
            <div aria-labelledby="emaillistLabel" class="offcanvas-xl offcanvas-end" id="emaillist" tabindex="-1">
                <div class="border-start border-light border-end h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center gap-2">
                            <button aria-label="Close" class="btn p-0 d-lg-none d-flex" data-bs-dismiss="offcanvas"
                                    data-bs-target="#emaillist" type="button">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="javascript: void(0);"><i
                                            class="ri-user-line me-2"></i>View
                                        Profile</a>
                                    <a class="dropdown-item" href="javascript: void(0);"><i
        ...
        <div class="col-xl-7">
            <div class="position-relative">
                <div class="card-header border-bottom bg-light-subtle d-flex align-items-center justify-content-between gap-2">
                    <button aria-controls="offcanvasExample"
                            class="btn btn-sm btn-icon btn-soft-primary d-xl-none d-flex align-items-center px-2"
                    ...
                    <button aria-controls="emaillist"
                            class="btn btn-sm btn-icon btn-soft-primary d-xl-none d-flex align-items-center px-2"
                            data-bs-target="#emaillist" data-bs-toggle="offcanvas" type="button">
