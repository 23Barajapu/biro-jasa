        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://quilljs.com/"
                                target="_blank"> Official Website </a>
                </h5>
                <p class="text-muted mb-3">Quilljs is a lightweight and powerful datetime
                    picker.</p>
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Use <code>bubble-editor</code> id to set bubble editor.
                </p>
                <div class="mb-3">
                    <!-- Bubble Editors -->
                ...
                <div class="highlight">
                    <div class="highlight-toolbar">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#bubble-editor-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#bubble-editor-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
