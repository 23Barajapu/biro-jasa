...
@php $subTitle = 'List Group'; @endphp
@php $title = 'UI'; @endphp
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Add <code>.disabled</code> to a <code>.list-group-item</code> to
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="taext-muted">Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to
                ...
                <div class="row p-3">
                    <div class="col-md-6">
                        <div class="list-group">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">A second link
                                item</a>
                            <a class="list-group-item list-group-item-action" href="#">A third link
                                item</a>
                            <a class="list-group-item list-group-item-action" href="#">A fourth link
                                item</a>
                    ...
                    <div class="col-md-6">
                        <div class="list-group">
                            ...
                            <button class="list-group-item list-group-item-action" type="button">A
                                second button item
                            </button>
                            <button class="list-group-item list-group-item-action" type="button">A third
                                button item
                            </button>
                            <button class="list-group-item list-group-item-action" type="button">A
                                fourth button item
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="taext-muted">Add <code>.list-group-flush</code> to remove some borders and
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="taext-muted">Add the <code>.list-group-numbered</code> modifier class (and
                ...
                <p class="taext-muted">Numbers are generated by <code>counter-reset</code> on the
...
<pre class="language-html">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Add <code>.list-group-horizontal</code> to change the layout of
                    ...
                    Currently <strong>horizontal list groups cannot be combined with flush list
                        groups.</strong></p>
                <p class="text-muted"><strong>ProTip:</strong> Want equal-width list group items when
                    horizontal? Add <code>.flex-fill</code> to each list group item.</p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Add nearly any HTML within, even for linked list groups like the
                    one below, with the help of <a href="/docs/5.2/utilities/flex/">flexbox
                        utilities</a>.</p>
                <div class="w-50 mb-3">
                    <div class="list-group">
                        <a aria-current="true" class="list-group-item list-group-item-action active" href="#">
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#active">Active items</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#disabled">Disabled items</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#links-buttons">Links and buttons</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#flush">Flush</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#numbered">Numbered</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#horizontal">Horizontal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#contextual-classes">Contextual classes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#custom-content">Custom content</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#checkboxes-radios">Checkboxes and Radios</a>
                </li>
            </ul>
        </div>
    </div>
