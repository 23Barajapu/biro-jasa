...
@php $subTitle = 'File Uploads'; @endphp
            ...
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview <a class="btn btn-sm btn-outline-success rounded-2 float-end"
                                href="https://www.dropzone.dev/js" target="_blank"> Official Website
                </a>
                </h5>
                <p class="text-muted mb-3">Dropzone is a lightweight and powerful datetime
                    picker.</p>
                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">Dropzone's CSS and Javascript files are bundled in the
                ...
                <div class="highlight">
                    <div class="highlight-toolbar">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab" href="#homePill">
...
<script src="{{ asset('assets/admin') }}/js/components/form-fileupload.js"></script>
@endsection
