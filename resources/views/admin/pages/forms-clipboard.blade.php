    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">Choices.js is a lightweight and powerful datetime
                    picker.</p>
                <h5 class="mt-2">Usage</h5>
                <p>Choices.js's CSS and Javascript files are bundled in the
                ...
                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart
                                                  at:</span> <code> ../static/js/components/form-clipboard.js</code>
                </p>
            </div><!-- end card-body -->
        </div><!-- end card -->
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">The value you include on this attribute needs to match
                    another's element selector.</p>
                <div class="w-50 mb-3">
                    <div class="input-group">
                        <input class="form-control" id="clipboard_example" placeholder="name@example.com" type="text"
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Additionally, you can define a
                    <code>data-clipboard-action</code> attribute to specify if you want to
                    either <code>copy</code> or <code>cut</code> content.</p>
                <div class="d-flex gap-2 align-items-start mb-3">
                    <textarea class="form-control w-50" cols="62" id="clipboard_cut" rows="6">Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</textarea>
                ...
                <div class="highlight">
                    <div class="highlight-toolbar">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#cut-element-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#cut-element-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
...
<pre class="language-javascript">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">Truth is, you don't even need another element to copy its
                    content from. You can just include a <code>data-clipboard-text</code>
                    attribute in your trigger element.</p>
                <div class="w-50 mb-3">
                    <!-- Trigger -->
                    <button class="btn btn-primary"
                            data-clipboard-text="Just because you can doesn't mean dfdyou should — clipboard.js"
                            id="clipboard_text">
                        Copy to clipboard
                    </button>
                </div>
                <div class="highlight">
                    <div class="highlight-toolbar">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a aria-expanded="false" class="nav-link active" data-bs-toggle="tab"
                                   href="#copy-attribute-html">
                                    <span class="fs-12 text-uppercase">html</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a aria-expanded="true" class="nav-link" data-bs-toggle="tab"
                                   href="#copy-attribute-javascript">
                                    <span class="fs-12 text-uppercase">javascript</span>
                                </a>
                            </li>
                        </ul>
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="#copy-from-element">Copy text from another
                        element</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#cut-from-element">Cut text from another
                        element</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#copy-from-attribute">Copy text from
                        attribute</a>
                </li>
            </ul>
        </div>
