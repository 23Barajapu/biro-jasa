...
<div id="side-hide">
    ...
    <div class="body">
        ...
        <h5 class="title mt--30">Solusi Terpercaya Proses Cepat</h5>

        <p class="disc">
            Biro Jasa Mahkota siap membantu Anda mengurus STNK, BPKB, Balik Nama, dan Mutasi dengan mudah dan terpercaya.
        </p>
        ...
        <div class="short-contact-area-side-collups">
            ...
            <div class="single-contact-information-side">
                ...
                <div class="information">
                    <span>Mail Us</span>
                    <a href="mailto:info@birojasamahkota.com" class="number">info@birojasamahkota.com</a>
            ...
            <div class="single-contact-information-side">
                ...
                <div class="information">
                    ...
                    <a href="#" class="number">Jl. Contoh No. 123, Kota Anda</a>
    ...
    <div class="mobile-menu-main">
        <nav class="nav-main mainmenu-nav mt--30">
            <ul class="mainmenu metismenu" id="mobile-menu-active">
                ...
                <li>
                    <a href="{{ route('index') }}#service" class="main">Service</a>
                </li>
                <li>
                    <a href="{{ route('balik-nama') }}" class="main">Balik Nama</a>
                </li>
            </ul>
        </nav>
    </div>
